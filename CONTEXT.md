...
- The functional MVP is not implemented yet, but the API surface, persistence layer, and simplified internal folder structure now support the remaining local-hardening and cloud steps without reworking the baseline.
