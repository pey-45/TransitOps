...
- Repository status: **Sprint 1 implemented.** The active greenfield root contains the .NET solution/API/tests, React frontend, Docker Compose, CI, design documentation and the reoriented LaTeX thesis. The previous implementation remains an archived reference oracle only.
