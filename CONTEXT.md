...
- The `dev` runtime plan now targets HTTPS on `api.dev.transitops.net` through Route53, ACM, and ALB. The Terraform stack remains unapplied; applying it will create cost-bearing runtime resources such as NAT Gateway, ALB, RDS, and ECS.
