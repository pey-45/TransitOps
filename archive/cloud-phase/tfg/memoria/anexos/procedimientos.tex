...
Este anexo recoge los procedimientos técnicos detallados para operar el entorno \texttt{dev} de TransitOps. Complementa el capítulo de operación y runbooks~(\ref{chap:operacion-runbooks}) con instrucciones paso a paso para recrear el entorno desde cero, validar la infraestructura localmente, cargar secretos, ejecutar migraciones, gestionar HTTPS y DNS, realizar auditorías de seguridad y coste, y preparar la defensa técnica del proyecto. Estos procedimientos permiten reproducir cualquier operación documentada en la memoria sin depender de conocimiento tácito.
