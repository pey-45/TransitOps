...
Este capítulo presenta el diseño arquitectónico global del sistema. Se describe la visión general de la solución, la organización interna del backend, la arquitectura de datos, la arquitectura cloud desplegada en AWS y las decisiones arquitectónicas clave que han guiado el proyecto, incluyendo las alternativas consideradas y descartadas.
