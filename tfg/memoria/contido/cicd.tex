...
Este capítulo describe el pipeline de integración y despliegue continuo definido para TransitOps. Se explican los objetivos del pipeline, los pasos de validación automática que garantizan la calidad antes de cada despliegue, la publicación de artefactos en ECR y los workflows de despliegue, rollback y recreación completa del entorno. El acceso a AWS se gestiona mediante OIDC, evitando credenciales de larga duración.
