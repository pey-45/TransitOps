...
Este capítulo sitúa el proyecto en su contexto tecnológico e industrial y define el marco de objetivos que guía el trabajo. Se presenta el entorno en el que surge la necesidad de plataformas cloud para gestión de transportes, el objetivo general y los objetivos específicos que estructuran el desarrollo, y finalmente los criterios de éxito observables que permiten evaluar si el trabajo ha cumplido sus metas.
...
\begin{itemize}
  ...
  \item El entorno \texttt{dev} expone un endpoint HTTPS real en \endpoint{api.dev.transitops.net}.
  ...
  \item Las peticiones son correlables mediante \httpheader{X-Correlation-ID} y los logs JSON pueden consultarse en CloudWatch.
  \item La infraestructura crea dashboard y alarmas operativas mínimas para ALB, ECS, RDS y errores de aplicación.
  \item El entorno \texttt{dev} puede destruirse con Terraform para eliminar recursos costosos tras capturar evidencias.
