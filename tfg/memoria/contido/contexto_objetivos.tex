...
Hasta el Sprint 6 se han alcanzado los criterios funcionales a nivel de pruebas de componente e integración y de verificaciones manuales por rebanada. No se declara todavía el éxito final: faltan las pruebas \gls{e2e} consolidadas, el despliegue accesible y el análisis de endurecimiento del Sprint 7. Esta distinción evita confundir una cobertura funcional amplia con un cierre de sistema todavía pendiente.
