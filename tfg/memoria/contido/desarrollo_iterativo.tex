...
Los eventos automáticos se añaden al mismo contexto antes del único \texttt{SaveChangesAsync} de la operación. En consecuencia, la modificación del envío y su traza se confirman en la misma transacción implícita: no puede quedar una salida sin evento ni un evento de una transición rechazada. Se prefirieron llamadas explícitas a un helper privado frente a eventos de dominio, interceptores o un bus, porque el tamaño del dominio no justifica ocultar este efecto lateral.
