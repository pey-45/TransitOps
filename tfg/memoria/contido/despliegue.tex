...
La composición de despliegue define cuatro servicios ---base de datos, API, servidor web y túnel--- y \emph{no publica ningún puerto en la máquina anfitriona}, tampoco el de PostgreSQL. Los tres primeros se comunican por la red privada de Compose; el cuarto, \texttt{cloudflared}, establece una conexión saliente con Cloudflare y ofrece una \gls{url} temporal con \gls{https}. No hay, por tanto, ninguna regla de entrada que abrir en el router ni superficie HTTP alternativa que quede a medio funcionar. El diagnóstico se realiza desde dentro de la máquina, consultando la salud a través del contenedor web.
...
\caption{Ejecución del procedimiento: descarga, salud de los cuatro servicios, revisión y \emph{digest} desplegados y dirección pública}
