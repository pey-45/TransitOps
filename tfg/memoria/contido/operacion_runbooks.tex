...
Este capítulo documenta la operación del entorno \texttt{dev} de TransitOps mediante runbooks. Un runbook es un procedimiento operativo que describe qué problema resuelve, qué pasos se ejecutan y qué señales confirman el éxito. Su presencia en la memoria refleja uno de los objetivos del proyecto: que el sistema sea operable y verificable sin depender de conocimiento tácito acumulado durante el desarrollo. Los procedimientos técnicos detallados se recogen en el Anexo~\ref{chap:anexo-procedimientos}.
