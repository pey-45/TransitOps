...
Primer administrador y \emph{hash} de contraseña & Backend & Correcto \\
...
Tras el Sprint 2 se ejecutaban 29 pruebas backend y 7 frontend. El Sprint 3 añadió 16 y 6 respectivamente, elevando el total a 45 pruebas backend y 13 frontend, todas correctas junto con el \emph{lint} y las compilaciones de producción.
...
El Sprint 5 elevó el total a 96 pruebas backend y 24 frontend. Las pruebas de controlador verifican la asociación del evento con el usuario real del token, no solo con un doble; las de servicio comprueban el orden estable, el aislamiento entre envíos y que una transición rechazada no deja rastro. El \emph{lint} y las compilaciones de producción permanecieron correctos.
